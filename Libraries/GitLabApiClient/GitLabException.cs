...
public sealed class GitLabException : Exception
{
    ...
    public GitLabException(HttpStatusCode statusCode, string message)
        : base(message)
        => HttpStatusCode = statusCode;

    public GitLabException(HttpStatusCode statusCode, string message, Exception innerException)
