...
public interface IMergeRequestsClient
{
    ...
    /// <returns>Merge requests satisfying options.</returns>
    Task<IList<MergeRequest>> GetAsync(GroupId groupId);
    ...
    public Task<MergeRequestApproval> GetApprovalsAsync(
        ProjectId projectId,
        int mergeRequestIid,
        Action<MergeRequestApprovalQueryOptions> options = null);
