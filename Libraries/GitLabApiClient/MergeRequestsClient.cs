...
public sealed class MergeRequestsClient : IMergeRequestsClient
{
    ...
    private readonly ProjectMergeRequestsApprovalQueryBuilder _projectMergeRequestsApprovalQueryBuilder;
    ...
    internal MergeRequestsClient(
        ...
        ProjectMergeRequestsApprovalQueryBuilder projectMergeRequestsApprovalQueryBuilder)
    {
        ...
        _projectMergeRequestsApprovalQueryBuilder = projectMergeRequestsApprovalQueryBuilder;
    }
    ...
    /// <summary>
    /// Retrieves merge request from a group.
    /// By default returns opened merged requests created by anyone.
    /// </summary>
    /// <param name="groupId">The ID, path or <see cref="Group"/> of the group.</param>
    /// <returns>Merge requests satisfying options.</returns>
    public async Task<IList<MergeRequest>> GetAsync(GroupId groupId)
    {
        string query = _projectMergeRequestsQueryBuilder.
            Build($"groups/{groupId}/merge_requests", new MergeRequestsQueryOptions());
    ...
    public async Task<MergeRequestApproval> GetApprovalsAsync(ProjectId projectId, int mergeRequestIid, Action<MergeRequestApprovalQueryOptions> options = null)
    {
        var queryOptions = new MergeRequestApprovalQueryOptions();
        options?.Invoke(queryOptions);

        string url = _projectMergeRequestsApprovalQueryBuilder.Build($"projects/{projectId}/merge_requests/{mergeRequestIid}/approvals", queryOptions);
        return await _httpFacade.Get<MergeRequestApproval>(url);
    }
