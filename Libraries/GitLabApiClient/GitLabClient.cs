...
public sealed class GitLabClient : IGitLabClient
{
    ...
    public GitLabClient(string hostUrl, string authenticationToken = "", HttpMessageHandler httpMessageHandler = null, TimeSpan? clientTimeout = null)
    {
        ...
        var projectMergeRequestApprovalQueryBuilder = new ProjectMergeRequestsApprovalQueryBuilder();
        ...
        MergeRequests = new MergeRequestsClient(_httpFacade, mergeRequestsQueryBuilder, projectMergeRequestsQueryBuilder, projectMergeRequestsNotesQueryBuilder, projectMergeRequestApprovalQueryBuilder);
